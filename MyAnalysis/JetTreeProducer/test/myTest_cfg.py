...
process.TFileService = cms.Service("TFileService",
  fileName = cms.string('jetTree_QCD_noPU_PFincldNEUTRAL_dzCut3D_newHR_PVcut_packedGEN_PFmatch_GenMatch_dRgenAsso_NewVZ_timeJet1.root'),  # This is where the flat ROOT file will be stored

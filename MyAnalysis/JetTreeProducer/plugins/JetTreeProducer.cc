...
*/
            ...
            part.setKinematics(pf.pt(), pf.eta(), pf.phi(), pf.energy(), pf.charge());
            part.setPuppiWeight(pf.puppiWeight());
            part.setPuppiWeightNoLep(pf.puppiWeightNoLep());

            if (pf.hasTrackDetails()) {
  		part.setDzSig(pf.dz() / pf.dzError());
		part.setTime(pf.time());
	    } else {
	      part.setDzSig(0);
  	      part.setTime(0);
	    }	   

//	    switch (pf.particleId()) {
//  	    case reco::PFCandidate::X: part.setParticleID(PFParticle::eX); break;
//  	    case reco::PFCandidate::h: part.setParticleID(PFParticle::eH); break;
//  	    case reco::PFCandidate::e: part.setParticleID(PFParticle::eE); break;
//  	    case reco::PFCandidate::mu: part.setParticleID(PFParticle::eMu); break;
//            case reco::PFCandidate::gamma: part.setParticleID(PFParticle::eGamma); break;
//            case reco::PFCandidate::h0: part.setParticleID(PFParticle::eH0); break;
//            case reco::PFCandidate::h_HF: part.setParticleID(PFParticle::eH_HF); break;
//            case reco::PFCandidate::egamma_HF: part.setParticleID(PFParticle::eEgamma_HF); break;
//            default: part.setParticleID(PFParticle::eX); break;
            
	    int pdgid=pf.pdgId();//int, from PackedCandidate
	    switch (std::abs(pdgid)) {
            case 211: part.setParticleID(PFParticle::eH); break;       // pi+
            case 11:  part.setParticleID(PFParticle::eE); break;       // e-
            case 13:  part.setParticleID(PFParticle::eMu); break;      // mu-
            case 22:  part.setParticleID(PFParticle::eGamma); break;   // photon
            case 130: part.setParticleID(PFParticle::eH0); break;      // K_L0
            default:  part.setParticleID(PFParticle::eX); break;
            }

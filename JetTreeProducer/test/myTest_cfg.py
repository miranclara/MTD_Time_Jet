...
process.TFileService = cms.Service("TFileService",
  fileName = cms.string('jetTree_QCD_200PU.root'),  # This is where the flat ROOT file will be stored
#  fileName = cms.string('jetTree_QCD_noPU.root'),  # This is where the flat ROOT file will be stored
